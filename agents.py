...
fetched_wallet = Wallet.fetch("b653aa46-9b1c-45dc-9a41-54f4e104d4b1")
...
def create_portfolio_non_custodial(array_tokens):
    ...
    asset_manager_treasury = "0xA5E1F2b36E01C6d4427Fce94a3D4297e4bfc4b8c"
    whitelisted_tokens = []
    management_fee = "100"
    performance_fee = "100"
    entry_fee = "100"
...
def deposit_portfolio_permit(user_address, portfolioAddress):
    try:
        ...
        try:
            ...
            if e.api_code == 'execution_reverted':
                print("Error: Unable to estimate gas for the transaction. Check your contract logic.")
            else:
                print(f"API Error: {e.api_message}")
